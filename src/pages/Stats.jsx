        ...
        <section className="mb-32 text-gray-800 text-center">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 lg:gap-x-0 items-center">
            <div className="mb-12 lg:mb-0 relative">
              ...
              <h5 className="text-lg font-medium text-[#000080] mb-4">40+</h5>
              <h6 className="font-medium text-gray-500">Regions</h6>
            ...
            <div className="mb-12 lg:mb-0 relative">
              ...
              <h5 className="text-lg font-medium text-[#000080] mb-4">220+</h5>
              <h6 className="font-medium text-gray-500">Services</h6>
              <hr className="absolute right-0 top-0 w-px bg-gray-200 h-full hidden lg:block" />
            </div>
            ...
            <div className="mb-12 md:mb-0 relative">
              ...
              <h5 className="text-lg font-medium text-[#000080] mb-4">120+</h5>
              <h6 className="font-medium text-gray-500">Features</h6>
              <hr className="absolute right-0 top-0 w-px bg-gray-200 h-full hidden lg:block" />
            </div>
            ...
            <div className="relative">
              ...
              <h5 className="text-lg font-medium text-[#000080] mb-4">28</h5>
