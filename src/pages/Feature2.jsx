    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
        <div className="lg:w-1/2">
          <h2 className="max-w-md mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none xl:max-w-lg">
            Your all-in-one online marketplace. .
          </h2>
        </div>
        <div className="lg:w-1/2">
          <p className="text-base text-gray-700 md:text-lg">
            Experience a whole new level of satisfaction with our automated
            systems. Fast, Reliable, Secure system for clients. A trial will
            most certainly change your perspective.
          </p>
        </div>
      </div>
      <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <h6 className="mb-2 font-semibold leading-5">Host</h6>
          <p className="mb-3 text-sm text-gray-900">
            Are you a convener looking to launch your campaigns? Let our system
            work for you.
          </p>
        ...
        <div>
          ...
          <h6 className="mb-2 font-semibold leading-5">Book</h6>
          <p className="mb-3 text-sm text-gray-900">
            Looking to attend your favorite event in town? No slip up! Grab that
            spot today!
          </p>
          <ul className="mb-4 -ml-1 space-y-2">
            <li className="flex items-start">
        ...
        <div>
          ...
          <h6 className="mb-2 font-semibold leading-5">Track</h6>
          <p className="mb-3 text-sm text-gray-900">
            Measure and monitor the progress of your campaigns.
          </p>
          <ul className="mb-4 -ml-1 space-y-2">
            <li className="flex items-start">
              <span className="mr-1">
        ...
        <div>
          ...
          <h6 className="mb-2 font-semibold leading-5">Feedbacks</h6>
          <p className="mb-3 text-sm text-gray-900">
            Rate your performance? Receive comments from clients and
            re-evaluate.
          </p>
          <ul className="mb-4 -ml-1 space-y-2">
            <li className="flex items-start">
